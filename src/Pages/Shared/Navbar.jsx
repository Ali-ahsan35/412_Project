...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="navbar fixed z-10 bg-opacity-30 bg-black text-white max-w-screen-2xl lg:flex lg:items-center">
        ...
        {user ? (
          <div className="navbar-end"> {user?.displayName} </div>
        ) : (
